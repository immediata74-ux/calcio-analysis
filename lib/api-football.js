...
export const football = {
  currentLeagues: () => apiFootball('/leagues', { current: 'true' }, { revalidate: 43200 }),
  ...
  leagueCompletedFixtures: (league, season) => apiFootball(
    '/fixtures',
    { league, season, status: 'FT-AET-PEN', timezone: 'Europe/Rome' },
    { revalidate: 21600 },
  ),
  teamLastFixtures: (team, last = 6) => apiFootball(
    '/fixtures',
    { team, last, timezone: 'Europe/Rome' },
    { revalidate: 21600 },
  ),
  playersByTeamSeason: (team, season, page = 1) => apiFootball('/players', { team, season, page }, { revalidate: 21600 }),
